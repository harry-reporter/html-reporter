...
import {suiteBegin, testBegin, testResult, testsEnd, initial} from '../modules/actions';
...
class Suites extends Component {
    ...
    _subscribeToEvents() {
        ...
        eventSource.addEventListener(clientEvents.END, (e) => {
            const sidebarItems = JSON.parse(e.data);
            this.props.actions.testsEnd(sidebarItems);
        });
    }
...
const actions = {testBegin, suiteBegin, testResult, testsEnd, initial};
